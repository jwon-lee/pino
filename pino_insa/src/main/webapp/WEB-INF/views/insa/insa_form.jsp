...
<body>
	...
	<article>
		...
		<div>
			<form action="/proj/insa_form.do" method="get" id="searchForm" name="searchForm">
				...
				<table class="employee_table1">
					...
					<tr>
						...
						<td colspan="2" class="bt_area">
							...
							<input type="button" value="이전" id="bt_prev" name="bt_prev" onclick="window.location.href='/proj/insa_form.do'"/>
						</td>						
					</tr>
				</table>
			</form>
