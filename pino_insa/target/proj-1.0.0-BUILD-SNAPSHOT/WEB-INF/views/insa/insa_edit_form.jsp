...
<!-- 			<table class="employee_table1" border="1"> -->
			<form id="insa_submit" name="insa_submit" action="/insa_update.do" method="post">
				<table class="employee_table1">
					<tr>
						<td colspan="2" rowspan="6">
							<img src="cdn.pixabay.com/photo/2017/06/21/07/51/icon-2426371_960_720.png" style="width:320px; height:240px;"/><br><br>
							<input type="button" value="사진올리기" id="bt_img_upload" name="bt_img_upload"/>
							<input type="file" style="display:none;" id="img_upload" name="img_upload"/>
						</td>
