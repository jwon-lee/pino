...
<!-- 			<table class="employee_table1" border="1"> -->
			<form id="insa_submit" name="insa_submit" action="/insa_insert.do" method="post" enctype="multipart/form-data">
				<table class="employee_table1">
					<tr>
						<td colspan="2" rowspan="6">
							...
							<input type="file" style="display:block;" id="img_upload" name="img_upload"/>
						</td>
...
<!-- 							<input type="text" id="email" name="email"/> -->
					...
					<tr>
						...
						<td colspan="4" class="bt_area2">
							...
							<input type="file" style="display:block;" id="cmp_reg" name="cmp_reg"/>
						</td>
					</tr>
					<tr>
						...
						<td colspan="4" class="bt_area2">
							...
							<input type="file" style="display: block;" id="carrier_reg" name="carrier_reg"/>
						</td>
					</tr>
				</table>
			</form>
		  ...
		  <div class="modal-dialog">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        <p><img alt="이미지가 없습니다.<c:out value='${request.getContext.contextPath}'/>" src="${request.getContext.contextPath()}"></p>
		      </div>
