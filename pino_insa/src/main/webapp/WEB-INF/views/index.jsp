		...
		<div class="title">
			...
			<div class="main_top_right">
				<nav class="header_nav">
					<a href="/proj/insa_main.do" class="main_menu_link">Home</a>
					<a href="/proj/insa_detail_form.do" class="main_menu_link">Input</a>
					<a href="/proj/insa_form.do" class="main_menu_link">Search</a>
				</nav>
			</div>
		</div>
	</header>
